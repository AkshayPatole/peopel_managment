      ...
      endDrawer: Drawer(
        child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              title: const Text(' Hiearchies '),
              onTap: () {
                Navigator.pop(context);
              },
            ),
            ListTile(
              title: const Text(' Company Datails '),
              onTap: () {
                Navigator.pop(context);
              },
            ),
            ListTile(
              title: const Text(' Approvals (1)',style: TextStyle(color: Colors.red),),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>Ten()));
              },
            ),
            ListTile(
