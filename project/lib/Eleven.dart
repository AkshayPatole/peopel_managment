              ...
              child: Column(
                children: [
                  Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("Mark Attendence",style: TextStyle(fontSize: 20),),
                          IconButton(
                              onPressed: () {},
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                           ...
                           Center(child: Text("Tap to Scan",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),))
                          ],
                        ),
                      )
                    ],
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Sanjay Shelke (Father)",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    ],
                  ),
                  SizedBox(
                    height: 20.h,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Sunita Shelke (Mother)",style: TextStyle(fontSize: 20.sp,fontWeight: FontWeight.bold),),
                    ],
                  ),
                  SizedBox(
                    height: 20.h,
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Lottie.asset("name.json",height: 70.h,width: 80.w,)),
